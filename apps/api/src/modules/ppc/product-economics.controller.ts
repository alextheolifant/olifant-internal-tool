...
export class ProductEconomicsController {
  constructor(private readonly productEconomicsService: ProductEconomicsService) {}
  ...
  @Patch('products/:id')
  update(@Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateProductEconomicsDto) {

...
import { changePassword } from "../_lib/auth-api";
...
function ChangePasswordSection() {
  ...
  const inputClass =
    "block w-full rounded-lg border border-neutral-200 px-3 py-2 text-[13px] text-ink outline-none focus:border-ink focus:ring-2 focus:ring-ink/10 transition-colors";
  ...
  return (
    <div className="mt-4 rounded-xl border border-neutral-200 bg-white p-5 shadow-sm">
      ...
      <p className="mt-1 text-[12px] text-neutral-500">Only affects your own login — not shared with your team.</p>

      <form onSubmit={handleSubmit} className="mt-4 space-y-3">
        <div className="space-y-1">
          <label htmlFor="currentPassword" className="block text-[11px] font-semibold uppercase tracking-wider text-neutral-400">
            Current Password
          </label>
          <input
            id="currentPassword"
        ...
        <div className="space-y-1">
          <label htmlFor="newPassword" className="block text-[11px] font-semibold uppercase tracking-wider text-neutral-400">
            New Password
          </label>
          <input
            id="newPassword"
        ...
        <div className="space-y-1">
          <label htmlFor="confirmPassword" className="block text-[11px] font-semibold uppercase tracking-wider text-neutral-400">
